...
to setup-neurons
  ...
  repeat Neurons-Hidden-Layer [
    create-hidden-neurons 1 [
      ...
      setxy 2 (-19 / Neurons-Hidden-Layer * ( who - Neurons-Input-Layer
                                                  - (Neurons-Hidden-Layer / 2) + 0.5))
      set activation random-float 0.1 ]]
  ...
  repeat Neurons-Output-Layer [
    create-output-neurons 1 [
      ...
      setxy 7 (-19 / Neurons-Output-Layer * ( who - Neurons-Input-Layer
                                                  - Neurons-Hidden-Layer
                                                  - (Neurons-Output-Layer / 2) + 0.5))
      set activation random-float 0.1]]
